# やさしい文章 (sentence-simplifier)

## 概要
難しい日本語→ふりがな付き簡単表現 (熟語変換、長文分割)
...
## コア機能
furigana-auto,kanji-replace,long-split,readability-score,toggle
...
- npm run lint 通過
- npm run build 通過
- release/sentence-simplifier.zip 生成
...
- 名前 (ja): やさしい文章
- 名前 (en): 
- 概要 (132字以内, ja): 難しい日本語→ふりがな付き簡単表現 (熟語変換、長文分割)
- カテゴリ: アクセシビリティ
- 言語: 日本語, English
- プライバシーポリシー URL: https://github.com/tabisurushosai/sentence-simplifier/blob/main/legal/PRIVACY.md
